...
insert into public.shop_items (key, kind, name, price, limited_until) values
  ('khung-vang', 'khung', 'Viền vàng', 200, null),
  ('khung-lua', 'khung', 'Viền lửa', 300, null),
  ('khung-bang', 'khung', 'Viền băng', 300, null),
  ('khung-cau-vong', 'khung', 'Cầu vồng', 400, null),
  ('khung-tot-nghiep', 'khung', 'Tốt nghiệp', 350, null),
  ('khung-trung-thu', 'khung', 'Trung thu', 250, date '2026-10-15'),
  ('khung-halloween', 'khung', 'Halloween', 250, date '2026-11-05'),
  ('khung-giang-sinh', 'khung', 'Giáng sinh', 250, date '2026-12-31'),
  ('khung-tet', 'khung', 'Tết', 250, date '2027-02-28'),
  ('bia-trung-thu', 'bia', 'Đêm trăng rằm', 200, date '2026-10-15'),
  ('bia-halloween', 'bia', 'Đêm Halloween', 200, date '2026-11-05'),
  ('bia-giang-sinh', 'bia', 'Giáng sinh', 200, date '2026-12-31'),
  ('bia-tet', 'bia', 'Tết', 200, date '2027-02-28'),
  ('bia-toeic-990', 'bia', 'TOEIC 990', 300, null),
  ('bia-ha-noi', 'bia', 'Hà Nội', 250, null),
  ('bia-sai-gon', 'bia', 'Sài Gòn', 250, null),
  ('bia-vu-tru', 'bia', 'Vũ trụ', 300, null),
  ('bia-bien', 'bia', 'Biển', 150, null),
  ('dh-cu-dem', 'danh-hieu', 'Cú đêm', 250, null),
  ('dh-mot-tu', 'danh-hieu', 'Mọt từ', 250, null),
  ('dh-chien-binh', 'danh-hieu', 'Chiến binh TOEIC', 300, null),
  ('dh-vit-vang', 'danh-hieu', 'Vịt vàng', 500, null),
