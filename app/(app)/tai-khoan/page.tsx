      ...
      <div className="stagger grid gap-6 px-5 pt-2 pb-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)] lg:items-start">
        ...
        <section aria-labelledby="ho-so" className="border-border bg-card overflow-hidden rounded-3xl border">
          ...
          <div className="px-5 pb-5">
            {/* Avatar chồng lên mép bìa, tên nằm ngang avatar nhưng canh đáy
                nên vẫn ở dưới ảnh; danh hiệu và email xuống dòng riêng. */}
            <div className="relative z-10 -mt-12 flex items-end gap-4">
              ...
              />
              <h2 id="ho-so" className="min-w-0 flex-1 truncate pb-1 text-2xl font-bold">
                {displayName}
              </h2>
            ...
            <div className="mt-2 min-w-0">
              ...
              <p className="text-muted mt-1 truncate text-xs">{user?.email}</p>
            </div>
            {profile?.bio ? (
